$(document).ready(function () {
    function success(position) {
      ...
      $.ajax({
        type: "GET",
        url: `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=167b57c505929b8da0a5d19017f6b443
        &units=imperial`,
        dataType: "json",
    ...
    function searchWeather(searchValue) {
      $.ajax({
        type: "GET",
        url: `https://api.openweathermap.org/data/2.5/weather?q=${searchValue}&appid=167b57c505929b8da0a5d19017f6b443
        &units=imperial`,
        dataType: "json",
        success: function(response) {
            console.log(response)
